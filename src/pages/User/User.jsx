                    ...
                    <form className="userUpdateForm">
                        <div className="userUpdateLeft">
                            ...
                            <div className="userUpdateItem">
                                ...
                                <input type='text' placeholder='Anna Backer' className='userUpdateInput'></input>
                            </div>
                            <div className="userUpdateItem">
                                <label>Email</label>
                                <input type='text' placeholder='annabeck@gmail.com' className='userUpdateInput'></input>
                            </div>
                            <div className="userUpdateItem">
                                <label>Phone</label>
                                <input type='text' placeholder='+1 123 456 78' className='userUpdateInput'></input>
                            </div>
                            <div className="userUpdateItem">
                                <label>Address</label>
                                <input type='text' placeholder='New York, USA' className='userUpdateInput'></input>
                            </div>
                        </div>
